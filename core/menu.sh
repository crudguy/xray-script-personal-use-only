...
# 功能描述: 取当前终端宽度 (列数)。
#           取值顺序: tput cols -> ${COLUMNS} (非数字则弃) -> 兜底 80。
#           非 TTY 场景 (cron / 管道 / 重定向) 下前两者都不可靠, 最终落到 80 ——
#           宁可显示完整 banner, 也不要误判成窄屏。
# 参数: 无
# 返回值: 打印列数 (恒为整数)
# =============================================================================
...
function print_banner() {
    # 窄终端降级: 下面两段 banner 由 base64 + ANSI 上色组成, 其中 ASCII art 本体宽 46 列,
    # 末行版权串 "Copyright (C) crudguy | https://github.com/..." 才是 80 列。窄终端下
    # 折行成乱版会盖住紧随其后的状态栏与菜单, 故宽度不足时改打一行紧凑标题。
    # 阈值取 80 (而非 46) 是为了保住版权行不被截断 —— 注释早年写的"宽约 70 列"两头不靠。
    ...
    0)
        echo "" | base64 --decode
        ;;
    # 如果是 1，打印第二个 Banner (解码后)
    1)
        echo "" | base64 --decode
        ;;
    esac
}
